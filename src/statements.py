...
class Comparision(Statement):
    ...
    def emit(self) -> bool:
        ...
        match self.opperation:
            case TokenType.EQ:
                self.emitter.emit_instruction(Opcode.JCN, "0b1100", self.emitter.generate_next_label())
            ...
            case TokenType.LT:
                self.emitter.emit_instruction(Opcode.JCN, "0b1110", self.emitter.generate_next_label())
                self.emitter.emit_instruction(Opcode.JCN, "0b0010", self.emitter.generate_next_label())
                self.parser.routine_handler.opperation_reg_to_reg_in_acc(1, 3, TokenType.MINUS)
